...
- Note (Scrum Master / Agile PM pathway): do **not** recommend POPM or RTE. Prefer SAFe Scrum Master when total experience is under 12 years; Leading SAFe (Agilist) when total experience is 12+ years. If YOE is unclear, prefer SAFe Scrum Master. Primary action for hands-on gaps remains **course-agile-fundamentals** (SM / Agile PM Live Project Mentorship).
- Note (Business Analyst / Product Owner pathway): Primary action for hands-on gaps remains **course-po-ba-mentorship** (BA / PO Live Project Mentorship). Prefer SAFe POPM when a SAFe PO/PM cert is clearly indicated.
